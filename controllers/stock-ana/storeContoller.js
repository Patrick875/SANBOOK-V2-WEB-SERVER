...
import { asyncWrapper } from "../../utils/handlingTryCatchBlocks.js";

const { Store, StockItemNew, StockItemValue, StockItemTransaction } = db;
...
const update = asyncWrapper(async (req, res) => {
	...
	if (!store) return res.status(404).json({ message: "stock item not found " });
